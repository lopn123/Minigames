...
{
    public class UIFishingEndManager : MonoBehaviour
    {
        [SerializeField]
        ...
        public void SetText_Money(int amount, Color? color = null)
        {
            text_money.text = "" + amount;

            if (color != null) text_money.color = (Color)color;
        }

        public void SetText_FishName(string name, Color? color = null)
        {
